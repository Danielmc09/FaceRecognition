...
def registro():
    ...
    pantalla1.geometry("350x300")  # Asignamos el tamaño de la ventana
...
def login():
    ...
    pantalla2.geometry("350x300")  # Creamos la ventana
...
def pantalla_principal():
    ...
    pantalla.title("TEAM COBRA")  # Asignamos el titulo de la pantalla
